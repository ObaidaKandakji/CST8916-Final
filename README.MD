...
- Fill in the **Basics**:
  ...
  - Name: `CST8916Final` (or any unique app name)
  - Publish: `Code`
  - Runtime stack: `Node 18 LTS` (or Node 20/24 LTS if available)
...
- Repository: `rideau-canal-dashboard` (or your actual repo name)  
- Branch: `main`  
